...
get_filename_component(directory "/home/ethan/Robobrawl/DDSClock/GUI/build/freetype-2.13.2/src/ft2" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-ft2${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-ft2${i}")
